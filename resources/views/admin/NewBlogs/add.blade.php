...
@section('content')
    ...
    @include('admin.layouts.partials.content_header',['name'=>'News','key'=>'Add'])
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                        <form class="" action="{{route('new.store')}}" method='post' enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <img  src="https://st.quantrimang.com/photos/image/2020/07/30/Hinh-Nen-Trang-10.jpg"
